alter table ALUMNO add constraint fk_es_evaluado_idGrupo foreign key (idGrupo) references GRUPO(idGrupo),
            add constraint fk_es_evaluado_idCurso foreign key (idCurso) references GRUPO(idCurso);

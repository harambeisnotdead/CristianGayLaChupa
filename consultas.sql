...
#QUITAR UN 20% DE LA NOTA DE CATALÁN A LOS ALUMNOS POR NO CALLAR EN CLASES Y ESCUCHAR MÚSICA MUY ALTA
...
UPDATE PERTENECE SET idDepartamento = (SELECT idDepartamento FROM `DEPARTAMENTO` WHERE nombreDepartamento = "Informatica") 
